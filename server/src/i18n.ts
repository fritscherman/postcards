...
const MESSAGES: Record<Lang, Dict> = {
  de: {
    ...
    'push.connected.title': '🤝 Neue Verbindung',
    'push.connected.body': '{{name}} ist jetzt mit dir verbunden.',
    'push.addedToBoard.title': '📌 Geteilte Pinwand',
    'push.addedToBoard.body': '{{name}} hat dich zur Pinwand „{{board}}“ hinzugefügt.',
  ...
  en: {
    ...
    'push.connected.title': '🤝 New connection',
    'push.connected.body': '{{name}} is now connected with you.',
    'push.addedToBoard.title': '📌 Shared pinboard',
    'push.addedToBoard.body': '{{name}} added you to the pinboard “{{board}}”.',
  ...
  fr: {
    ...
    'push.connected.title': '🤝 Nouvelle connexion',
    'push.connected.body': '{{name}} est désormais connecté·e avec toi.',
    'push.addedToBoard.title': '📌 Tableau partagé',
    'push.addedToBoard.body': '{{name}} t’a ajouté·e au tableau « {{board}} ».',
  ...
  tr: {
    ...
    'push.connected.title': '🤝 Yeni bağlantı',
    'push.connected.body': '{{name}} artık seninle bağlantılı.',
    'push.addedToBoard.title': '📌 Paylaşılan pano',
    'push.addedToBoard.body': '{{name}} seni „{{board}}“ panosuna ekledi.',
  ...
  it: {
    ...
    'push.connected.title': '🤝 Nuovo collegamento',
    'push.connected.body': '{{name}} ora è in contatto con te.',
    'push.addedToBoard.title': '📌 Bacheca condivisa',
    'push.addedToBoard.body': '{{name}} ti ha aggiunto alla bacheca «{{board}}».',
